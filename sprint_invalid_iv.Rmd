...
```
Due to random variation and potential model mis-specification, the simulated data set has higher impact of SBP on the outcome, which is why the coefficient has been inflated slightly.
